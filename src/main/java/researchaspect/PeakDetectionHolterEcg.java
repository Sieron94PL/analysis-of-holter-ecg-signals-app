...
public class PeakDetectionHolterEcg {
    ...
    private static final String CRECG_FILE = "crecg.dat";
    private static final String XLS_RESULTS_DIRECTORY = ECG_HOLTER_DATA_DIRECTORY + "Results\\";
    private static final String[] folderNames = {"Save091", "Save124", "Save078", "Save076", "Save065", "Save031", "Save052", "Save023", "Save011", "Save002"};
    private static final int SAMPLING_FREQUENCY = 128;
    ...
    private static final int[] signalStarts = {
            (12 * ONE_HOUR),
            (18 * ONE_HOUR),
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < folderNames.length; i++) {
            ...
            ECGSignal ecgSignal = ReadCardioPathSimple.load(ECG_HOLTER_DATA_DIRECTORY + folderNames[i] + "\\" + CRECG_FILE, channels, SAMPLING_FREQUENCY);
